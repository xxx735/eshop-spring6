          ...
          <ul class="pagination justify-content-center">
          	<c:choose>
          		<c:when test="${page.pageIndex == 1}">
          			<li class="page-item">
          				<a class="page-link" href="${pageContext.request.contextPath}/category/all?pageSize=${page.pageSize}&pageIndex=${page.pageIndex}">前一页</a></li>
          		</c:when>
            	<c:otherwise>
            		<li class="page-item">
            			<a class="page-link" href="${pageContext.request.contextPath}/category/all?pageSize=${page.pageSize}&pageIndex=${page.pageIndex-1}">前一页</a></li>
            	</c:otherwise>
            </c:choose>
            <c:forEach begin="1" end="${page.totalPage}" varStatus="status">
            	<li class="page-item">
            		<a class="page-link" href="${pageContext.request.contextPath}/category/all?pageSize=${page.pageSize}&pageIndex=${status.index}">${status.index}</a></li>
            </c:forEach>
            <c:choose>
          		<c:when test="${page.pageIndex == page.totalPage}">
          			<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/category/all?pageSize=${page.pageSize}&pageIndex=${page.pageIndex}">后一页</a></li>
          		</c:when>
            	<c:otherwise>
            		<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/category/all?pageSize=${page.pageSize}&pageIndex=${page.pageIndex+1}">后一页</a></li>
            	</c:otherwise>
            </c:choose>
          </ul>
        </nav>
