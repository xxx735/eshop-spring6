      ...
      <div class="col-md-6 mt-3 mt-md-0">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-md-end bg-transparent p-0 m-0">
            ...
            <li class="breadcrumb-item"><a class="link-title" href="${pageContext.request.contextPath}/category/all">全部分类</a></li>
                        ...
                        <div class="card-info">
                          ...
                          <div class="card-footer bg-transparent border-0">
                            <div class="product-link d-flex align-items-center justify-content-center">
                              <a class="btn-cart btn btn-pink mx-3" type="button" href="${pageContext.request.contextPath}/cart/add/${product.id}">
          ...
          <ul class="pagination justify-content-center">
          	<c:choose>
          		<c:when test="${page.pageIndex == 1}">
          			<li class="page-item">
          				<a class="page-link" href="${pageContext.request.contextPath}/category/list/${id}?pageSize=${page.pageSize}&pageIndex=${page.pageIndex}">前一页</a></li>
          		</c:when>
            	<c:otherwise>
            		<li class="page-item">
            			<a class="page-link" href="${pageContext.request.contextPath}/category/list/${id}?pageSize=${page.pageSize}&pageIndex=${page.pageIndex-1}">前一页</a></li>
            	</c:otherwise>
            </c:choose>
            <c:forEach begin="1" end="${page.totalPage}" varStatus="status">
            	<li class="page-item">
            		<a class="page-link" href="${pageContext.request.contextPath}/category/list/${id}?pageSize=${page.pageSize}&pageIndex=${status.index}">${status.index}</a></li>
            </c:forEach>
            <c:choose>
          		<c:when test="${page.pageIndex == page.totalPage}">
          			<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/category/list/${id}?pageSize=${page.pageSize}&pageIndex=${page.pageIndex}">后一页</a></li>
          		</c:when>
            	<c:otherwise>
            		<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/category/list/${id}?pageSize=${page.pageSize}&pageIndex=${page.pageIndex+1}">后一页</a></li>
            	</c:otherwise>
            </c:choose>
          </ul>
        </nav>
